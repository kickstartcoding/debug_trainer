...
var $author$project$Utils$Types$BreakType$allBreakTypes = _List_fromArray(
	[$author$project$Utils$Types$BreakType$CaseSwap, $author$project$Utils$Types$BreakType$RemoveReturn, $author$project$Utils$Types$BreakType$RemoveParenthesis, $author$project$Utils$Types$BreakType$ChangeFunctionArgs]);
var $author$project$Commands$Hint$Cmd$changeDescriptionFromBreakType = function (breakType) {
	switch (breakType.$) {
		case 'CaseSwap':
			...
			function () {
				if (!changes.b) {
					...
					if (!changes.b.b) {
						...
						return 'HINT: ' + $author$project$Commands$Hint$Cmd$changeDescriptionFromBreakType(breakType);
					} else {
							...
							A2(
								...
								function (_v3) {
									...
									return _Utils_ap(
										...
										$author$project$Commands$Hint$Cmd$changeDescriptionFromBreakType(breakType));
								},
								A2(
									$elm$core$List$filter,
									function (_v2) {
...
var $author$project$Commands$Break$Update$BreakFile$buildChanges = F3(
	function (config, segments, changes) {
		...
		while (true) {
			var _v0 = function () {
				var _v1 = A2($elm$core$List$drop, config.breakCount * 2, config.model.randomNumbers);
				if (_v1.b && _v1.b.b) {
					var num1 = _v1.a;
					var _v2 = _v1.b;
					var num2 = _v2.a;
			...
			var breakRunnerData = {originalFileContent: config.fileContent, randomNumber: segmentChoiceSeed, segments: segments};
			...
			if (maybeChanges.$ === 'Just') {
				var _v4 = maybeChanges.a;
				var newSegments = _v4.a;
				var change = _v4.b;

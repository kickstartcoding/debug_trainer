		...
		var newModel = _Utils_update(
			model,
			{
				command: $author$project$Model$Break(
					_Utils_update(
						breakData,
						{fileSaveStatus: newFileSaveStatus}))
			});
		return _Utils_Tuple2(
			newModel,
...
var $author$project$Commands$Break$Update$BreakFile$run = function (_v0) {
	...
	var maybeChange = function () {
		var _v2 = $author$project$Parsers$Generic$Parser$run(fileContent);
		if (_v2.$ === 'Ok') {
			var segments = _v2.a;
			var maybeBreakType = A2($author$project$Commands$Break$Update$BreakFile$chooseBreakType, segments, 12345);
			var breakRunnerData = {originalFileContent: fileContent, randomNumber: 1234567, segments: segments};

...
var $author$project$Utils$Cmd$fromFileData = F3(
	function (filepath, _v0, fileDataFunc) {
		var savedDataResult = _v0.savedDataResult;
		var dataFilePath = _v0.dataFilePath;
		var workingDirectory = _v0.workingDirectory;
		if (savedDataResult.$ === 'Ok') {
			var savedData = savedDataResult.a;
			var _v2 = A2(
			...
			if (_v2.$ === 'Just') {
				var fileData = _v2.a;
				return A2(fileDataFunc, savedData, fileData);
			} else {
				return $author$project$Ports$printAndExitSuccess(
...
var $author$project$Commands$Explain$Cmd$init = F2(
	function (filepath, model) {
		return A3(
			$author$project$Utils$Cmd$fromFileData,
			filepath,
			model,
			F2(
				function (_v0, _v1) {
...
function save(saveDataContents) {
  ...
  _fs.default.writeFile(dataFilePath, contents, function (err) {
    (0, _logging.devLog)('Saved data contents:', contents);
...
function _default(program) {
  program.ports.writeFile.subscribe(fileData => {
    ...
    _fs.default.writeFile(fileData.path, fileData.contents, function (err) {
      ...
      (0, _logging.devLog)('New file contents written!'); // SavedData.save(fileData.dataToSave)

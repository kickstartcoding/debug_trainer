		...
		A3(
			...
			A3(
				...
				$miniBill$elm_codec$Codec$custom(
					F4(
						function (caseSwap, removeReturn, changeFunctionArgs, value) {
							switch (value.$) {
								case 'CaseSwap':
									return caseSwap;
								case 'RemoveReturn':
...
var $author$project$Commands$Break$Update$chooseBreakType = F2(
	function (segments, _v0) {
		...
		var totalCandidateCount = (caseSwapCandidateCount + returnStatementCandidateCount) + functionDeclarationCandidateCount;
	...
	function (_v0, action, model) {
		switch (action.$) {
			...
			default:
				var filepath = action.a;
				var subAction = action.b;
				var _v4 = A3($author$project$Commands$Reset$Update$update, filepath, subAction, model);
				var newModel = _v4.a;
				var cmd = _v4.b;
				return _Utils_Tuple2(
					newModel,
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'workingDirectory', $elm$json$Json$Decode$string)))({"versions":{"elm":"0.19.1"},"types":{"message":"Actions.Action","aliases":{},"unions":{"Actions.Action":{"args":[],"tags":{"BreakAction":["Utils.Types.FilePath.FilePath","Commands.Break.Actions.Action"],"HintAction":["Utils.Types.FilePath.FilePath","Commands.Hint.Actions.Action"],"ResetAction":["Utils.Types.FilePath.FilePath","Commands.Reset.Actions.Action"]}},"Commands.Break.Actions.Action":{"args":[],"tags":{"ReceiveFileContents":["String.String"]}},"Commands.Hint.Actions.Action":{"args":[],"tags":{"NoOp":[]}},"Commands.Reset.Actions.Action":{"args":[],"tags":{"NoOp":[]}},"Utils.Types.FilePath.FilePath":{"args":[],"tags":{"FilePath":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));
},{}],"ports/print.js":[function(require,module,exports) {
"use strict";
...
},{}],"ports/printAndExitFailure.js":[function(require,module,exports) {
"use strict";
...
},{}],"ports/printAndExitSuccess.js":[function(require,module,exports) {
"use strict";
...
},{}],"logging.js":[function(require,module,exports) {
"use strict";
...
},{}],"ports/readFile.js":[function(require,module,exports) {
"use strict";
...
function _default(program) {
  program.ports.readFile.subscribe(filepath => {
    ...
    _fs.default.readFile(filepath, 'utf8', function (err, contents) {
      if (err) {
        console.error(err);
        process.exit(1);
      }
...
function load(program) {
  (0, _logging.devLog)(`Loading data from ${dataFilePath}...`);

  if (_fs.default.existsSync(dataFilePath)) {
    return _fs.default.readFileSync(dataFilePath, 'utf8');
  } else {
    return null;
  }
}
...
function save(saveDataContents) {
  (0, _logging.devLog)(`Saving data to ${dataFilePath}...`);

  if (!_fs.default.existsSync(dataFilePath)) {
    _fs.default.closeSync(_fs.default.openSync(dataFilePath, 'w'));
  }

  const contents = JSON.stringify(saveDataContents, null, "  ");

  _fs.default.writeFile(dataFilePath, contents, function (err) {
    ...
    (0, _logging.devLog)('Data successfully saved!');
    process.exit(0);
  });
}
...
var SavedData = _interopRequireWildcard(require("../savedData.js"));
...
function _default(program) {
  program.ports.writeFile.subscribe(fileData => {
    (0, _logging.devLog)(`Writing new contents of ${fileData.path}...`);

    _fs.default.writeFile(fileData.path, fileData.contents, function (err) {
      if (err) {
        console.error(err);
        process.exit(1);
      }

      (0, _logging.devLog)('New file contents written!');
...
var _printAndExitFailure = _interopRequireDefault(require("./ports/printAndExitFailure.js"));

var _printAndExitSuccess = _interopRequireDefault(require("./ports/printAndExitSuccess.js"));

var _readFile = _interopRequireDefault(require("./ports/readFile.js"));

var _writeFile = _interopRequireDefault(require("./ports/writeFile.js"));
...
function run() {
  ...
  const portFunctions = [_print.default, _printAndExitFailure.default, _printAndExitSuccess.default, _readFile.default, _writeFile.default];
...
},{"../elm/Main.elm":"../elm/Main.elm","./ports/print.js":"ports/print.js","./ports/printAndExitFailure.js":"ports/printAndExitFailure.js","./ports/printAndExitSuccess.js":"ports/printAndExitSuccess.js","./ports/readFile.js":"ports/readFile.js","./ports/writeFile.js":"ports/writeFile.js","./savedData.js":"savedData.js","./logging.js":"logging.js"}]},{},["main.js"], null)
